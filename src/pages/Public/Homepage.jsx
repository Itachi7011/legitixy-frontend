...
import lawyerNetwork from "../../images/6dd4a01a1f.jpg";
import lawyerNetwork1 from "../../images/lawyerNetwork1.jpg";
import justiceIndian from "../../images/justiceIndian.jpg";
import happyclients from "../../images/happyclients.jpg";
import happyfamily from "../../images/happyfamily.jpg";

import court1 from "../../images/courts/Supreme_Court_of_India.jpg";
import court2 from "../../images/courts/allahabad.jpg";
import court3 from "../../images/courts/Mumbai.jpg";
import court4 from "../../images/courts/Madras.jpg";
import court5 from "../../images/courts/Calcutta_High_Court.jpg";

import court6 from "../../images/courts/delhi.jpg";
import court7 from "../../images/courts/Karnataka.jpg";
import court8 from "../../images/courts/gujarat.jpg";
import court9 from "../../images/courts/rajasthan.jpg";
import court10 from "../../images/courts/Punjab.jpg";

import court11 from "../../images/courts/Kerala_Building.jpg";
import court12 from "../../images/courts/Telangana_in_Hyderabad.jpg";
import court13 from "../../images/courts/Andhra_Pradesh.jpg";
import court14 from "../../images/courts/MadhyaPradesh.jpg";
import court15 from "../../images/courts/patna.jpg";

import court16 from "../../images/courts/Punjab.jpg";
import court17 from "../../images/courts/Odisha_High_Court.JPG";
import court18 from "../../images/courts/Jharkhand_High_Court.jpg";
import court19 from "../../images/courts/Gauhati.jpg";
import court20 from "../../images/courts/uttarakhan.jpeg";

import court21 from "../../images/courts/himacha.jpeg";
import court22 from "../../images/courts/JammyKashmir.jpg";
import court23 from "../../images/courts/manipu.jpeg";
import court24 from "../../images/courts/meghalaya.jpg";
import court25 from "../../images/courts/tripura.jpg";
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      if (!deleting && displayed === current) {
        ...
        setDisplayed((p) =>
          deleting ? p.slice(0, -1) : current.slice(0, p.length + 1),
        );
      }
    }, speed);
...
const Section = ({ children, className = "", id = "" }) => {
  ...
  return (
    <section
      ref={ref}
      id={id}
      className={`${className} ${vis ? "hp-sec-vis" : "hp-sec-hid"}`}
    >
      {children}
    </section>
  );
...
const WABtn = () => (
  <a
    href="https://wa.me/919876543210?text=Hello%2C%20I%20need%20legal%20help"
    target="_blank"
...
const StickyCTA = ({ isDarkMode }) => {
  ...
  return (
    <div
      className={`hp-sticky ${isDarkMode ? "dark" : "light"} ${show ? "hp-sticky--on" : ""}`}
    >
      <span className="hp-sticky__txt">
        Free legal consultation — verified lawyers across all of India &
        worldwide
      </span>
      <Link to="/consult-lawyer" className="hp-sticky__btn">
        <Phone size={13} /> Consult Free
      </Link>
    </div>
  );
};
...
const Lexi = ({ isDarkMode }) => {
  const [msgs, setMsgs] = useState([
    {
      role: "bot",
      text: "Hi! I'm Lexi 👋 Ask me anything about Indian law — divorce, bail, property, cyber crime, NRI issues and more. I'll guide you instantly.",
    },
  ]);
  ...
  return (
    <div className={`hp-lexi ${isDarkMode ? "dark" : "light"}`}>
      <div className="hp-lexi__head">
        <div className="hp-lexi__avatar">
          <Bot size={18} />
        </div>
        <div>
          <div className="hp-lexi__name">Lexi — AI Legal Assistant</div>
          <div className="hp-lexi__status">
            <span className="hp-lexi__dot" /> Always Online · Indian Law KB
          </div>
        </div>
      </div>
      <div className="hp-lexi__msgs">
        {msgs.map((m, i) => (
          <div
            key={i}
            className={`hp-lexi__msg hp-lexi__msg--${m.role}`}
        ...
        {typing && (
          <div className="hp-lexi__msg hp-lexi__msg--bot">
            <span className="hp-lexi__dots">
              <span />
              <span />
              <span />
            </span>
      ...
      <div className="hp-lexi__row">
        <input
          ...
          className="hp-lexi__input"
          aria-label="Legal question"
        />
        <button onClick={send} className="hp-lexi__send" aria-label="Send">
          <Send size={15} />
        </button>
      </div>
    </div>
...
const HIGH_COURTS = [
  {
    ...
    img: court1,
    tag: "Apex Court",
    path: "/delhi-high-court",
  },
  {
    name: "Allahabad High Court",
    loc: "Prayagraj, Uttar Pradesh",
    est: "1866",
    img: court2,
    tag: "High Court",
    path: "/blog",
  ...
  {
    name: "Andhra Pradesh HC",
    loc: "Amaravati, Andhra Pradesh",
    est: "2019",
    img: court13,
    tag: "High Court",
    path: "/blog",
...
const TRIBUNALS = [
  {
    ...
    loc: "New Delhi + 4 Benches",
  },
  {
    abbr: "NCLT",
    name: "National Company Law Tribunal",
    jurisdiction: "Insolvency, company law",
    loc: "15 Benches Pan India",
  },
  {
    abbr: "NCDRC",
    name: "National Consumer Commission",
    jurisdiction: "Consumer disputes >₹10Cr",
    loc: "New Delhi",
  },
  {
    abbr: "ITAT",
    name: "Income Tax Appellate Tribunal",
    jurisdiction: "Income tax disputes",
    loc: "Pan India",
  },
  {
    abbr: "DRT",
    name: "Debt Recovery Tribunal",
    jurisdiction: "Bank debt recovery >₹20L",
    loc: "39 DRTs Pan India",
  },
  {
    abbr: "RERA",
    name: "Real Estate Regulatory Authority",
    jurisdiction: "Real estate disputes",
    loc: "State-wise portals",
  },
  {
    abbr: "AFT",
    name: "Armed Forces Tribunal",
    jurisdiction: "Armed forces service matters",
    loc: "New Delhi + 8 Benches",
  },
  {
    abbr: "SAT",
    name: "Securities Appellate Tribunal",
    jurisdiction: "SEBI orders",
    loc: "Mumbai",
  },
  {
    abbr: "CAT",
    name: "Central Administrative Tribunal",
    jurisdiction: "Central govt service matters",
    loc: "17 Benches",
  },
  {
    abbr: "IPAB",
    name: "Intellectual Property Board",
    jurisdiction: "Trademark, patent, copyright",
    loc: "New Delhi, Mumbai, Chennai",
  },
  {
    abbr: "TDSAT",
    name: "Telecom Disputes Tribunal",
    jurisdiction: "Telecom disputes",
    loc: "New Delhi",
  },
  {
    abbr: "CESTAT",
    name: "Customs, Excise, Service Tax AT",
    jurisdiction: "Indirect tax disputes",
    loc: "4 Benches",
  },
];
...
const PRACTICE_AREAS = [
  {
    ...
    title: "Family Law",
    color: "#E07B54",
    colorBg: "rgba(224,123,84,0.10)",
    desc: "Divorce, custody, maintenance, domestic violence, adoption and marriage laws across all Indian states.",
    links: [
      { l: "Divorce in India", p: "/divorce-delhi" },
      { l: "Child Custody", p: "/child-custody" },
      { l: "498A Help", p: "/498a-case-help" },
      { l: "Maintenance 125 CrPC", p: "/maintenance-125-crpc" },
    ],
  },
  {
    ...
    title: "Property Law",
    color: "#4A9D8E",
    colorBg: "rgba(74,157,142,0.10)",
    desc: "Property disputes, partition, builder fraud, RERA, land acquisition, title search across all states.",
    links: [
      { l: "Property Dispute", p: "/property-dispute" },
      { l: "Partition Suit", p: "/partition-suit" },
      { l: "Builder Fraud", p: "/builder-fraud" },
  ...
  },
  {
    ...
    title: "Criminal Law",
    color: "#C0392B",
    colorBg: "rgba(192,57,43,0.10)",
    desc: "Bail, FIR quashing, anticipatory bail, NDPS, white collar crime and criminal appeals in all courts.",
    links: [
      { l: "Bail Process", p: "/bail-process" },
      { l: "Anticipatory Bail", p: "/anticipatory-bail" },
      { l: "FIR Quashing", p: "/fir-quashing" },
      { l: "NDPS Cases", p: "/ndps-case" },
    ],
  },
  {
    ...
    title: "Civil Law",
    color: "#7B68EE",
    colorBg: "rgba(123,104,238,0.10)",
    desc: "Cheque bounce, money recovery, specific performance, injunctions, defamation and civil appeals.",
    links: [
      { l: "Cheque Bounce 138", p: "/cheque-bounce-138-ni-act" },
      { l: "Money Recovery", p: "/money-recovery-suit" },
      { l: "Legal Notice", p: "/legal-notice-format" },
      { l: "Consumer Complaint", p: "/consumer-complaint" },
    ],
  },
  {
    ...
    title: "Cyber Law",
    color: "#1A7A8A",
    colorBg: "rgba(26,122,138,0.10)",
    desc: "Cyber crime FIR, UPI fraud, data theft, online harassment, IT Act and digital rights violations.",
    links: [
      { l: "Cyber Crime FIR", p: "/cyber-crime-complaint" },
      { l: "UPI Fraud Case", p: "/upi-fraud-case" },
      { l: "Data Theft", p: "/data-theft-case" },
      { l: "IT Act Explained", p: "/it-act-explained" },
    ],
  },
  {
    ...
    title: "Corporate Law",
    color: "#5B8DD9",
    colorBg: "rgba(91,141,217,0.10)",
    desc: "Company law, NCLT, insolvency, M&A, FEMA, GST disputes and startup legal compliance.",
    links: [
      { l: "Company Dispute", p: "/blog" },
      { l: "NCLT Filing", p: "/blog" },
      { l: "Partnership Dispute", p: "/defamation-case" },
      { l: "GST Dispute", p: "/blog" },
    ],
  },
  {
    ...
    desc: "Writ petitions, fundamental rights, PIL, election law and constitutional challenges to legislation.",
    links: [
      { l: "Writ Petition", p: "/blog" },
      { l: "PIL Filing", p: "/blog" },
      { l: "Fundamental Rights", p: "/blog" },
      { l: "Election Dispute", p: "/blog" },
    ],
  },
  {
    icon: <Globe size={24} />,
    ...
    desc: "NRI divorce, property, OCI issues, GPA, inheritance, cross-border disputes and immigration law.",
    links: [
      { l: "NRI Divorce", p: "/nri-divorce" },
      { l: "NRI Property", p: "/property-dispute" },
      { l: "Power of Attorney", p: "/blog" },
      { l: "Succession Cert.", p: "/succession-certificate" },
    ],
  },
  {
    icon: <Heart size={24} />,
    ...
    desc: "Wrongful termination, PF/ESI disputes, POSH Act, labour court, gratuity and trade union matters.",
    links: [
      { l: "Wrongful Termination", p: "/blog" },
      { l: "PF/ESI Dispute", p: "/blog" },
      { l: "POSH Act", p: "/blog" },
      { l: "Labour Court", p: "/blog" },
    ],
  },
  {
    ...
    desc: "Income tax appeals, GST disputes, ITAT, advance rulings and international tax matters.",
    links: [
      { l: "Income Tax Appeal", p: "/blog" },
      { l: "GST Dispute", p: "/blog" },
      { l: "ITAT Proceedings", p: "/blog" },
      { l: "International Tax", p: "/blog" },
    ],
  },
  {
    ...
    color: "#8E44AD",
    colorBg: "rgba(142,68,173,0.10)",
    desc: "Trademark, copyright, patent filing, IP infringement, domain disputes and licensing agreements.",
    links: [
      { l: "Trademark Reg.", p: "/blog" },
      { l: "Copyright", p: "/blog" },
      { l: "Patent Filing", p: "/blog" },
      { l: "IP Infringement", p: "/blog" },
    ],
  },
  {
    ...
    title: "Education Law",
    color: "#F39C12",
    colorBg: "rgba(243,156,18,0.10)",
    desc: "Admission disputes, UGC issues, scholarship problems, exam malpractice and teacher service matters.",
    links: [
      { l: "Admission Dispute", p: "/blog" },
      { l: "UGC Issues", p: "/blog" },
      { l: "Exam Malpractice", p: "/blog" },
      { l: "Teacher Service", p: "/blog" },
    ],
  },
];
...
const TOOLS = [
  {
    ...
    path: "/divorce-cost-calculator",
    desc: "State-wise divorce cost estimate",
    color: "#E07B54",
  },
  {
    ...
    desc: "Monthly alimony estimation",
    color: "#4A9D8E",
  },
  {
    icon: <ShieldCheck size={19} />,
    title: "Bail Eligibility Checker",
    path: "/bail-eligibility-checker",
    desc: "Check bail conditions & chances",
    color: "#C0392B",
  },
  {
    icon: <HomeIcon size={19} />,
    title: "Property Share Calculator",
    path: "/property-share-calculator",
    desc: "Partition share by Hindu Succession Act",
    color: "#7B68EE",
  },
  {
    ...
    desc: "Filing fees for any Indian court",
    color: "#1A7A8A",
  },
  {
    icon: <ScrollText size={19} />,
    title: "Legal Notice Generator",
    path: "/legal-notice-generator",
    desc: "Legally valid notice in 2 minutes",
    color: "#C9A84C",
  },
  {
    ...
    path: "/blog",
    desc: "State-wise stamp duty rates",
    color: "#27AE60",
  },
  {
    ...
    path: "/blog",
    desc: "Legally valid rent deed draft",
    color: "#5B8DD9",
  },
  {
    ...
    path: "/blog",
    desc: "Structured FIR for any crime",
    color: "#E74C3C",
  },
];
...
const WORLD_LAWYERS = [
  {
    ...
    regions: "UK · USA · Canada · Australia · UAE",
    icon: <Globe size={22} />,
    color: "#5B8DD9",
    desc: "Divorce, property, succession & power of attorney for Indians living abroad. Available in 50+ countries.",
  },
  {
    title: "International Arbitration",
    regions: "Singapore · Dubai · London · New York",
    icon: <Briefcase size={22} />,
    color: "#7B68EE",
    desc: "Cross-border commercial disputes, enforcement of foreign arbitral awards in Indian courts.",
  },
  {
    title: "Immigration & Visa Law",
    regions: "USA · UK · Canada · Australia · Schengen",
    icon: <Flag size={22} />,
    color: "#E07B54",
    desc: "Visa rejections, deportation defence, OCI/PIO card issues, H1B, student visa and asylum cases.",
  },
  {
    ...
    color: "#4A9D8E",
    desc: "Cross-border M&A, FDI compliance, FEMA, joint ventures and international contract drafting.",
  },
  {
    title: "Intellectual Property",
    regions: "India + 180 Countries via PCT/Madrid",
    icon: <Lightbulb size={22} />,
    color: "#C9A84C",
    desc: "International trademark, patent PCT filings, copyright and IP enforcement worldwide.",
  },
  {
    title: "Human Rights & Asylum",
    regions: "UN Geneva · UNHCR · International Courts",
    icon: <Heart size={22} />,
    color: "#C0392B",
    desc: "International human rights violations, refugee status, asylum applications and statelessness cases.",
  },
];

const RESOURCES = [
  {
    title: "IPC/BNS Sections Explained",
    path: "/blog",
    tag: "Criminal Law",
  ...
  {
    title: "IT Act 2000 Guide",
    path: "/it-act-explained",
    tag: "Cyber Law",
  ...
  {
    title: "Writ Petitions Article 226",
    path: "/blog",
    tag: "Constitutional",
...
const TESTIMONIALS = [
  {
    ...
    text: "Legitixy connected me with the right property lawyer within hours. My ancestral property case spanning 3 generations was resolved in 4 months. Exceptional platform.",
    rating: 5,
  ...
  },
  {
    ...
    text: "Going through a contested divorce was devastating. The guidance here and the lawyer I found made the process fair and dignified. Truly grateful to the Legitixy team.",
    rating: 5,
    img: null,
  },
  {
    name: "Adv. Mohan Tiwari",
    role: "Criminal Lawyer, Allahabad HC",
    city: "Prayagraj, UP",
    text: "As a practising advocate, I recommend Legitixy to clients needing preliminary guidance. Content is accurate, updated and genuinely helpful to the common man.",
    rating: 5,
    img: null,
  },
  {
    name: "Sunita Verma",
    role: "498A Defense Client",
    city: "Jaipur, Rajasthan",
    text: "My husband was falsely implicated in a 498A case. Legitixy gave us a clear path forward and connected us with an expert. The case was resolved without going to trial.",
    rating: 5,
    img: null,
  },
  {
    name: "Arjun Nair",
    role: "NRI Property Client",
    city: "Kerala / London, UK",
    text: "Managing ancestral property from London was a nightmare until Legitixy. They connected me with an NRI specialist who handled the mutation, sale, and repatriation seamlessly.",
    rating: 5,
    img: null,
  },
  {
    name: "Deepa Krishnan",
    role: "RERA Complainant",
    city: "Chennai, Tamil Nadu",
    text: "Builder delayed my flat by 3 years and refused to refund. With Legitixy's RERA guide and lawyer connect, I got full refund plus 11.5% interest. Couldn't have done it alone.",
    rating: 5,
    img: null,
  },
];
...
const Home = () => {
  ...
  const filtered =
    searchQ.length > 1
      ? suggestions.filter((s) =>
          s.toLowerCase().includes(searchQ.toLowerCase()),
        )
      : [];
  ...
  const EMERGENCY = [
    ...
    },
    {
      ...
      path: "/property-dispute",
      tag: "Property",
      color: "#4A9D8E",
    },
    {
      icon: <Monitor size={19} />,
      title: "Cyber Crime FIR",
      path: "/cyber-crime-complaint",
      tag: "Cyber",
      color: "#1A7A8A",
    },
    {
      icon: <FileText size={19} />,
      title: "Cheque Bounce 138",
  ...
  return (
    <div className={`hp-page ${isDarkMode ? "dark" : "light"}`}>
      ...
      <section className="hp-hero">
        ...
        <div className="hp-hero__inner">
          <div className="hp-hero__content">
            <div className="hp-hero__pill">
              ...
              India's Most Comprehensive Legal Platform — All 28 States + UTs +
              50 Countries
            </div>
            ...
            <p className="hp-hero__sub">
              Supreme Court to District Court. Family law to corporate law.
              Delhi to Kanyakumari to London. Connect with{" "}
              <strong>verified Indian lawyers</strong>, get court guides, and
              use free legal tools.{" "}
              <strong>100% confidential. Free to browse.</strong>
            </p>

            {/* AI search */}
            <div
              className={`hp-search ${searchFocus ? "hp-search--focus" : ""}`}
            >
              ...
              <input
                ...
                placeholder="Search any legal problem, law section, or court across India…"
                className="hp-search__inp"
                aria-label="Search"
              />
              <Link to="/consult-lawyer" className="hp-search__btn">
                <Zap size={13} /> Get Help
              </Link>
              {searchFocus && filtered.length > 0 && (
                <ul className="hp-search__drop">
                  {filtered.map((s, i) => (
                    <li key={i}>
                      <button
                        onMouseDown={() => setSearchQ(s)}
                        className="hp-search__sugg"
                      >
                        <Search size={11} />
                        {s}
                      </button>
            ...
            <div className="hp-hero__ctas">
              ...
              <a href="#practice" className="hp-btn hp-btn--ghost hp-btn--lg">
                <ArrowRight size={15} /> Explore Legal Areas
              </a>
            </div>
            ...
            <div className="hp-hero__trust">
              {[
                ...
                <span key={i} className="hp-hero__badge">
                  {b.i}
                  {b.l}
                </span>
              ))}
          ...
          <div className="hp-hero__visual">
            <ImgSlot
              src={home1}
              alt="India Legal Platform"
              aspectRatio="4/5"
              className="hp-hero__img"
            />
            <div className="hp-hero__sc hp-hero__sc--1">
              <Scale size={14} />
              <div>
                <strong>
            ...
            <div className="hp-hero__sc hp-hero__sc--2">
              <Gavel size={14} />
              <div>
                <strong>
            ...
            <div className="hp-hero__sc hp-hero__sc--3">
              <Globe size={14} />
              <div>
                <strong>50+</strong>
                <span>Countries</span>
        ...
        <div className="hp-scroll-line" aria-hidden>
      ...
      <div className={`hp-stats ${isDarkMode ? "dark" : "light"}`}>
        <div className="hp-container">
          <div className="hp-stats__grid">
            {[
              { n: 100000, s: "+", l: "Users Helped Pan-India" },
              { n: 98, s: "%", l: "Success Rate" },
              { n: 1500, s: "+", l: "Verified Lawyers" },
              { n: 25, s: "", l: "High Courts Covered" },
              { n: 700, s: "+", l: "District Courts Listed" },
              { n: 50, s: "+", l: "Countries NRI Services" },
            ].map((s, i) => (
              <div key={i} className="hp-stats__item">
                <span className="hp-stats__num">
      ...
      <Section className="hp-emg" id="emergency">
        <div className="hp-container">
          <div className="hp-emg__head">
            <div className="hp-emg__alarm">
              <AlarmClock size={19} />
            </div>
            <div>
              <h2 className="hp-emg__title">Need Immediate Legal Help?</h2>
              <p className="hp-emg__sub">
                India's most-searched legal situations — get instant guidance
                and lawyer connect
              </p>
            </div>
          </div>
      ...
      <Section className="hp-practice" id="practice">
        <div className="hp-container">
          <div className="hp-shead">
            ...
            <h2 className="hp-stitle">
              12 Legal Domains. <span className="hp-gold">All Covered.</span>
            </h2>
            <p className="hp-ssub">
              From family law to international arbitration — comprehensive
              guides for every branch of Indian law, with state-specific
              coverage.
            </p>
          </div>
          <div className="hp-practice__grid">
            {PRACTICE_AREAS.map((a, i) => (
              <div
                key={i}
                className="hp-pcard"
                style={{ "--acc": a.color, "--acc-bg": a.colorBg }}
              >
                ...
                <ul className="hp-pcard__links">
                  {a.links.map((lk, j) => (
                    <li key={j}>
                      <Link to={lk.p} className="hp-pcard__link">
        ...
        <div className="hp-container">
          <div className="hp-lexi-sec__inner">
            <div className="hp-lexi-sec__left">
              ...
              <h2 className="hp-stitle">
                Meet <span className="hp-gold">Lexi</span> — Your 24/7 Legal
                Guide
              </h2>
              <p className="hp-ssub" style={{ textAlign: "left" }}>
                Can't wait for office hours? Lexi answers Indian legal questions
                instantly — divorce, bail, property, cyber crime, consumer
                rights, NRI law and more. No API, no data sharing — runs
                entirely on Legitixy's legal knowledge base.
              </p>
              <div className="hp-lexi-sec__feats">
                {[
                  {
                    i: <Brain size={16} />,
                    t: "Trained on Indian law, IPC, CrPC, HMA, IT Act",
                  },
                  {
                    i: <Zap size={16} />,
                    t: "Instant answers — no waiting, no login required",
                  },
                  {
                    i: <Lock size={16} />,
                    t: "Private & anonymous — nothing stored",
                  },
                  {
                    i: <MessageCircle size={16} />,
                    t: "Plain language — no legal jargon needed",
                  },
                ].map((f, i) => (
                  <div key={i} className="hp-lexi-sec__feat">
                    <span className="hp-lexi-sec__feat-ico">{f.i}</span>
                    <span>{f.t}</span>
                  </div>
                ))}
              </div>
              <p className="hp-lexi-sec__note">
                <HelpCircle size={13} />
                Lexi provides general legal information, not advice.{" "}
                <Link to="/consult-lawyer" className="hp-link-gold">
      ...
      <Section className="hp-courts" id="courts">
        <div className="hp-container">
          <div className="hp-shead">
            ...
            <h2 className="hp-stitle">
              Every Court in <span className="hp-gold">India.</span>
            </h2>
            <p className="hp-ssub">
              Supreme Court to all 25 High Courts, 700+ District Courts and 12
              major Tribunals — your complete guide to India's judicial system
              with procedures, timings, jurisdiction and filing guides.
            </p>
          </div>
          ...
          <div className="hp-ctabs">
            {[
              {
                k: "high",
                l: "Supreme & High Courts (25)",
                i: <Building2 size={14} />,
              },
              {
                k: "district",
                l: "District Courts (700+)",
                i: <Landmark size={14} />,
              },
              {
                k: "tribunal",
                l: "Tribunals & Commissions (12)",
                i: <Scale size={14} />,
              },
            ].map((t) => (
              <button
                key={t.k}
                className={`hp-ctab ${courtTab === t.k ? "hp-ctab--on" : ""}`}
                onClick={() => setCourtTab(t.k)}
              >
                {t.i} {t.l}
              </button>
            ))}
            ...
            <div className="hp-dc-grid">
              {DISTRICT_COURTS.map((c, i) => (
                <Link key={i} to={c.path} className="hp-dc-card">
                  <div className="hp-dc-icon">
                    <Landmark size={18} />
                  </div>
                  <div className="hp-dc-body">
                    <h3 className="hp-dc-name">{c.name}</h3>
                    <p className="hp-dc-state">
              ...
              <div className="hp-dc-card hp-dc-more">
                <Globe size={22} />
                <div>
                  <strong>700+ District Courts</strong>
                  <span>Across all 28 States + UTs</span>
                </div>
                <Link to="/blog" className="hp-btn hp-btn--ghost">
                  View All
                </Link>
              </div>
            </div>
      ...
      <Section className="hp-tools">
        <div className="hp-container">
          <div className="hp-shead">
            ...
            <h2 className="hp-stitle">
              Smart Tools. <span className="hp-gold">Instant Answers.</span>
            </h2>
            <p className="hp-ssub">
              India's only complete free legal calculator suite. No signup
              required — get instant clarity on costs, eligibility, and legal
              documents.
            </p>
          </div>
          <div className="hp-tools__grid">
            {TOOLS.map((t, i) => (
              ...
              >
                ...
                <div className="hp-tool__body">
                  <h3 className="hp-tool__title">{t.title}</h3>
                  <p className="hp-tool__desc">{t.desc}</p>
                </div>
      ...
      <Section className="hp-lawyers" id="lawyers">
        <div className="hp-container">
          <div className="hp-shead">
            ...
            <h2 className="hp-stitle">
              Verified Lawyers.{" "}
              <span className="hp-gold">India & Worldwide.</span>
            </h2>
            <p className="hp-ssub">
              From Supreme Court advocates to local district court lawyers — and
              specialised international legal services for the 30-million-strong
              Indian diaspora worldwide.
            </p>
          </div>
          <ImgSlot
            src={lawyerNetwork1}
            alt="Verified Indian Lawyers Network"
            aspectRatio="21/6"
            className="hp-lawyers__hero-img"
          />
          ...
          <div className="hp-lawyers__grid">
            {[
              ...
              >
                ...
                <div className="hp-lcard__stars">
                  {[...Array(5)].map((_, j) => (
                    <Star key={j} size={11} fill="currentColor" />
                  ))}
                  <span>4.9</span>
                </div>
                <div className="hp-lcard__cta">
                  Find {l.t} <ArrowRight size={11} />
                </div>
              </Link>
            ))}
          </div>

          <h3 className="hp-lawyers__sub-h" style={{ marginTop: "60px" }}>
            International & NRI Legal Services
          </h3>
          <div className="hp-world__grid">
            {WORLD_LAWYERS.map((l, i) => (
              <div key={i} className="hp-wcard" style={{ "--acc": l.color }}>
                ...
                <p className="hp-wcard__regions">
                  <Globe size={11} /> {l.regions}
                </p>
                <p className="hp-wcard__desc">{l.desc}</p>
                <Link to="/consult-lawyer" className="hp-wcard__btn">
                  Find Specialist <ArrowRight size={12} />
                </Link>
              </div>
            ))}
          </div>
          ...
          <div className="hp-lawyers__bottom">
            <p>
              Can't find a specialist? Tell us your issue — we match you within
              2 hours.
            </p>
            <Link
              to="/consult-lawyer"
              className="hp-btn hp-btn--gold hp-btn--lg"
            >
              <Phone size={14} /> Free Case Evaluation
            </Link>
          </div>
        </div>
      </Section>
          ...
          <div className="hp-why__inner">
            <div className="hp-why__left">
              <span
                ...
                style={{ color: "var(--ln-gold-light,#E2B85A)" }}
              >
                Why Legitixy
              </span>
              <h2 className="hp-stitle" style={{ color: "#fff" }}>
                Built for India.
                <br />
                <span className="hp-gold">For Every Indian.</span>
              </h2>
              <p
                style={{
              ...
              >
                We built Legitixy because navigating India's legal system felt
                impossible without money or connections. From a farmer in Bihar
                to an NRI in London — justice for all.
              </p>
              <div className="hp-why__stats">
                {[
                  { n: 100000, s: "+", l: "Users Helped" },
                  { n: 98, s: "%", l: "Success Rate" },
                  { n: 1500, s: "+", l: "Verified Lawyers" },
                  { n: 25, s: "", l: "High Courts" },
                  { n: 700, s: "+", l: "District Courts" },
                  { n: 50, s: "+", l: "Countries" },
                ].map((s, i) => (
                  <div key={i} className="hp-why__stat">
                    <span className="hp-why__stat-n">
                      <AnimatedCounter end={s.n} suffix={s.s} />
                    </span>
              ...
              <Link to="/consult-lawyer" className="hp-btn hp-btn--gold">
                <Phone size={14} /> Start Free Consultation
              </Link>
            </div>
            <div className="hp-why__right">
              <ImgSlot
                src={justiceIndian}
                alt="Justice for all Indians"
                aspectRatio="3/4"
                className="hp-why__img"
              />
              <div className="hp-why__pts">
                {WHY_POINTS.map((p, i) => (
                  <div key={i} className="hp-why__pt">
                    ...
                    <div>
                      <h4 className="hp-why__pt-title">{p.title}</h4>
                      <p className="hp-why__pt-desc">{p.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <Section className="hp-resources">
        <div className="hp-container">
          <div className="hp-shead">
            ...
            <h2 className="hp-stitle">
              Learn the Law <span className="hp-gold">in Plain Language.</span>
            </h2>
            <p className="hp-ssub">
              Plain-English explainers of India's most important laws — updated
              regularly by practising advocates. No law degree needed.
            </p>
          </div>
            ...
            {RESOURCES.map((r, i) => (
              <Link key={i} to={r.path} className="hp-rcard">
                ...
                <div className="hp-rcard__body">
                  ...
                  <span className="hp-rcard__time">
                    <Clock size={10} /> {r.time} read
                  </span>
                </div>
          ...
          <div style={{ textAlign: "center", marginTop: "36px" }}>
            <Link to="/blog" className="hp-btn hp-btn--ghost">
              <Newspaper size={14} /> View All Legal Articles
            </Link>
          </div>
        </div>
      </Section>
      ...
      <Section className="hp-testimonials">
        <div className="hp-container">
          <div className="hp-shead">
            ...
            <h2 className="hp-stitle">
              Real People. <span className="hp-gold">Real Results.</span>
            </h2>
            <p className="hp-ssub">
              From Kashmir to Kanyakumari, from Mumbai to London — thousands of
              Indians trust Legitixy with their most sensitive legal matters.
            </p>
          </div>
          <div className="hp-tgrid">
            {TESTIMONIALS.map((t, i) => (
              <div key={i} className="hp-tcard">
                <div className="hp-tcard__stars">
                ...
                <div className="hp-tcard__author">
                  ...
                  <div>
                    <div className="hp-tcard__name">{t.name}</div>
                    <div className="hp-tcard__role">
                      {t.role} · {t.city}
                    </div>
                  </div>
          ...
          <ImgSlot
            src={happyfamily}
            alt="Happy clients across India"
            aspectRatio="21/5"
            className="hp-testimonials__strip"
          />
        </div>
      </Section>
      ...
      <Section className="hp-faq">
        <div className="hp-container">
          <div className="hp-shead">
            ...
            <h2 className="hp-stitle">
              Your Legal Questions <span className="hp-gold">Answered.</span>
            </h2>
            <p className="hp-ssub">
              India's most commonly searched legal questions, answered in plain
              language by our team of verified advocates.
            </p>
          </div>
        ...
        <div className="hp-container">
          <div className="hp-cta__inner">
            <div className="hp-cta__left">
              <div className="hp-cta__ico">
                <Scale size={30} />
              </div>
              <h2 className="hp-cta__h2">
                Talk to a Lawyer <span className="hp-gold">Today.</span>
              </h2>
              <p className="hp-cta__sub">
                Free 15-minute consultation with a verified Indian advocate.
                Available across all states and for NRI clients worldwide.
              </p>
              <div className="hp-cta__checks">
                {[
                  "Free first consultation",
                  "Matched by case type & location",
                  "Response within 2 hours",
                  "Available for NRIs worldwide",
                  "Verified Bar Council advocates only",
                ].map((c, i) => (
                  <div key={i} className="hp-cta__check">
              ...
              <div className="hp-cta__contacts">
                <a href="tel:+919876543210" className="hp-cta__contact">
              ...
              <ImgSlot
                src={lawyerNetwork}
                alt="Our Verified Indian Lawyer Network"
                aspectRatio="16/7"
                className="hp-cta__group-img"
              />
            </div>
            <div className="hp-cta__form-wrap">
              {formSent ? (
                ...
                <form className="hp-cta__form" onSubmit={handleForm}>
                  <h3 className="hp-cta__form-h">
                    <Zap size={15} /> Free Case Evaluation
                  </h3>
                  <input
                    type="text"
                  ...
                  <select
                    ...
                    className="hp-cta__inp hp-cta__sel"
                    required
                    aria-label="State"
                  >
                  ...
                  >
                    ...
                    <option>Criminal Case / Bail</option>
                    <option>498A / Dowry Case</option>
                    <option>Civil / Financial Case</option>
                    <option>Cyber Crime</option>
                    <option>Corporate / Business</option>
                    <option>NRI Legal Matter</option>
                    <option>Consumer Complaint</option>
                    <option>Labour / Employment</option>
                    <option>Tax Dispute</option>
                    <option>Intellectual Property</option>
                    <option>Constitutional / PIL</option>
                    <option>Other</option>
                  </select>
                  <button
                    type="submit"
                  ...
                  <p className="hp-cta__note">
                    <Lock size={11} /> 100% confidential · No spam · No
                    obligation ever
                  </p>
                </form>
              )}
...
const WHY_POINTS = [
  {
    ...
    desc: "All content reviewed by practising advocates registered with Bar Councils across India.",
  },
  {
    icon: <Map size={19} />,
    title: "Pan-India + Global Coverage",
    desc: "All 28 States, 8 UTs, 25 High Courts, 700+ District Courts and 50+ countries for NRIs.",
  },
  {
    icon: <Phone size={19} />,
    title: "Free Initial Consultation",
    desc: "First 15 minutes free, no hidden charges, no obligation to proceed, no spam calls.",
  },
  {
    icon: <ShieldCheck size={19} />,
    title: "100% Confidential",
    desc: "Protected by attorney-client privilege and our DPDP Act 2023 compliant privacy policy.",
  },
  {
    icon: <Globe size={19} />,
    title: "NRI & International Reach",
    desc: "Legal assistance for the Indian diaspora across USA, UK, Canada, Australia, UAE and 50+ countries.",
  },
  {
    icon: <Clock size={19} />,
    title: "24/7 AI + 9AM-9PM Lawyers",
    desc: "Lexi answers instantly any time. Verified lawyers connect within 2 hours during business hours.",
  },
  {
    icon: <HeartHandshake size={19} />,
    title: "Transparent Lawyer Matching",
    desc: "Matched by case type, location and language preference. No referral fees from lawyers.",
  },
  {
    icon: <ThumbsUp size={19} />,
    title: "No Hidden Charges",
    desc: "All fee structures disclosed upfront. We never charge hidden commissions or success fees.",
  },
];
